...
#ifndef TENSORFLOW_LITE_MICRO_MICRO_MODEL_SETTINGS_H_
#define TENSORFLOW_LITE_MICRO_MICRO_MODEL_SETTINGS_H_
...
#endif  // TENSORFLOW_LITE_MICRO_MICRO_MODEL_SETTINGS_H_
