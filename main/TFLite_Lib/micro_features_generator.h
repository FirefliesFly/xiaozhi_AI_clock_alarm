...
#ifndef TENSORFLOW_LITE_MICRO_MICRO_FEATURES_MICRO_FEATURES_GENERATOR_H_
#define TENSORFLOW_LITE_MICRO_MICRO_FEATURES_MICRO_FEATURES_GENERATOR_H_
...
#endif  // TENSORFLOW_LITE_MICRO_MICRO_FEATURES_MICRO_FEATURES_GENERATOR_H_
